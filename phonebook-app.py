...
app.config['MYSQL_DATABASE_DB'] = 'clarusway-phonebook'
...
# Write a function named `init_todo_db` create phonebook table within clarusway-phonebook db, if it doesn't exist

def init_phonebook_db():
    phonebook_table = """
    CREATE TABLE IF NOT EXISTS clarusway-phonebook.phonebook(
